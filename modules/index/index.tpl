    ...
    <head>
        ...
        <script>
            ...
            function redirectToLogin() {
                ...
                var redirectUri = 'https://daguaniko.com';
                var loginUrl = "https://daguaniko.auth.${region}.amazoncognito.com/login?client_id=${clientId}&response_type=code&scope=email+openid+phone&redirect_uri=https%3A%2F%2Fdaguaniko.com";
            ...
            function getCredentials(authCode) {
                var clientId = '${clientId}';
                var redirectUri = 'https://daguaniko.com';
                var authEndpoint = 'https://daguaniko.auth.${region}.amazoncognito.com/oauth2/token';
            ...
            localStorage.clear();
            window.location.href = "https://daguaniko.auth.${region}.amazoncognito.com/logout?client_id=${clientId}&logout_uri=https%3A%2F%2Fdaguaniko.com";
            }
